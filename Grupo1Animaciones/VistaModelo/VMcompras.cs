...
using Grupo1Animaciones.Datos;
using Grupo1Animaciones.Vistas;
using Plugin.SharedTransitions;
namespace Grupo1Animaciones.VistaModelo
{
    public class VMcompras : BaseViewModel
    {
        ...
        public void Dibujarproductos(Mproductos item, int index, StackLayout Carriderecha, StackLayout Carrilizquierda)
        {
            ...
            var labelcalificacion = new Label
            {
            ...
            stack.Children.Add(labelcalificacion);
            frame.Content = stack;
        ...
        private async Task AnimacionesrAsync()
        {
            await Application.Current.MainPage.Navigation.PushModalAsync(new Animaciones());
        }

        #endregion
        #region COMANDOS
        public ICommand AnimacionesCommand => new Command(async () => await AnimacionesrAsync());
